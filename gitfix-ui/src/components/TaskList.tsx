      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          <select 
            ...
            className="px-3 py-2 bg-brand-border border border-brand-border text-brand-text-light rounded-md focus:ring-2 focus:ring-brand-accent focus:border-brand-accent cursor-pointer"
          >
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-brand-border">
              {tasks.map((task, index) => (
                ...
                >
                  <td className="py-4 px-4 text-sm text-brand-text-dim">
